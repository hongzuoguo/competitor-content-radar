...
export function HighlightInspector({
  ...
  return (
    <div className="inspector-layer">
      ...
      <aside aria-label="作品拆解摘要" aria-modal="true" className="inspector" role="dialog">
        ...
        <div className="inspector__body">
          ...
          <section>
            ...
            <dl className="inspector__metrics">
              ...
              <div><dt>相对爆款</dt><dd>{highlight.relativeViralIndex ?? '样本不足'}</dd></div>
              <div><dt>借鉴评分</dt><dd>{highlight.referenceValueScore ?? '待分析'}</dd></div>
            </dl>
          </section>
        </div>
