...
export function WorksPage(): React.JSX.Element {
  ...
  return (
    <div className="page workspace-page">
      <header className="page-heading"><div><h1>作品分析</h1><p>按表现信号筛选作品，沉淀可复用的选题、钩子和结构。</p></div><Button icon={<SlidersHorizontal size={16} />} variant="secondary">管理视图</Button></header>
