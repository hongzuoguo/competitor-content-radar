...
describe('first-run setup wizard', () => {
  it('guides the user through login, AI, Feishu, creator and schedule', () => {
    ...
    expect(document.querySelector<HTMLInputElement>('#setup-daily')).toHaveValue('08:00')
    expect(document.querySelector<HTMLInputElement>('#setup-daily')).toBeDisabled()
    expect(complete).toHaveBeenCalledTimes(1)
    expect(complete).toHaveBeenCalledWith(expect.objectContaining({ dailyTime: '08:00' }))
  })
})
